...
plan.cnt_plan = [
    [
        [1.0, -0.13039155, 0.1784435, 0.0, 0.0, T],
        [1.0, 0.09660845, 0.1784435, 0.0, 0.0, T],
        [1.0, -0.13039155, 0.0445565, 0.0, 0.0, T],
        [1.0, 0.09660845, 0.0445565, 0.0, 0.0, T],
        [1.0, -0.13039155, -0.0445565, 0.0, 0.0, T],
        [1.0, 0.09660845, -0.0445565, 0.0, 0.0, T],
        [1.0, -0.13039155, -0.1784435, 0.0, 0.0, T],
        [1.0, 0.09660845, -0.1784435, 0.0, 0.0, T],
...
plan.W_X = np.array([1e0, 1e0, 1e4, 1e-4, 1e-4, 2e2, 3e4, 1e4, 3e4])
plan.W_X_ter = 10.0 * np.array([1e3, 1e-5, 1e4, 1e-1, 1e-1, 2e2, 1e1, 1e1, 1e1])
...
plan.bounds = [[-0.5, -0.5, 1.1, 0.5, 0.5, 1.14, 0.0, T]]
