...
plan.cnt_plan = [
    [
        [1.0, HC_init_x, -MC_init_out_y, 0.0, 0.0, plan.stance_time],
        [1.0, TC_init_x, -MC_init_out_y, 0.0, 0.0, plan.stance_time],
        [1.0, HC_init_x, -MC_init_in_y, 0.0, 0.0, plan.stance_time],
        [1.0, TC_init_x, -MC_init_in_y, 0.0, 0.0, plan.stance_time],
        [1.0, HC_init_x, MC_init_in_y, 0.0, 0.0, plan.stance_time],
        [1.0, TC_init_x, MC_init_in_y, 0.0, 0.0, plan.stance_time],
        [1.0, HC_init_x, MC_init_out_y, 0.0, 0.0, plan.stance_time],
        [1.0, TC_init_x, MC_init_out_y, 0.0, 0.0, plan.stance_time],
...
plan.X_nom = [
    [0.0, 0, 0.4, 0, 0, 0, 0, 0.00, 0.0, 0.0, plan.stance_time],
    [
        0.0,
        0,
        1.2,
    ...
    [0.0, 0.0, 0.9, 0, 0, 0, 0, 0.0, 0.0, plan.stance_time + plan.flight_time, plan.T],
]
...
plan.swing_wt = [
    [
        [
            ...
            plan.stance_time + 0.6 * plan.flight_time,
        ],
        [
            0.0,
            0.0,
