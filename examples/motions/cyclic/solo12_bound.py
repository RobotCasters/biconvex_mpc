...
bound.state_wt = np.array(
    [0.0, 0, 1e3]
    + [10, 10, 10]
    + [50.0] * (pin_robot.model.nv - 6)
    + [0.00] * 3
    + [100, 10, 100]
    + [0.5] * (pin_robot.model.nv - 6)
)
#
...
#
# Dyn
bound.W_X = np.array([1e-5, 1e-5, 5e4, 1e1, 1e1, 1e3, 5e3, 1e4, 5e3])
bound.W_X_ter = 10 * np.array([1e-5, 1e-5, 5e4, 1e1, 1e1, 1e3, 1e4, 1e4, 1e4])
bound.W_F = np.array(4 * [1e1, 1e1, 1.5e1])
bound.nom_ht = 0.25
bound.rho = 5e4
...
bound_turn.cent_wt = [5e1, 5e2]
bound_turn.step_ht = 0.07
bound_turn.reg_wt = [7e-3, 7e-5]
#
# Dyn
bound_turn.W_X = np.array([1e-5, 1e-5, 5e4, 1e1, 1e1, 1e3, 5e3, 1e4, 5e3])
bound_turn.W_X_ter = 10 * np.array([1e-5, 1e-5, 5e4, 1e1, 1e1, 1e3, 1e4, 1e4, 1e4])
bound_turn.W_F = np.array(4 * [1e1, 1e1, 1.5e1])
...
air_bound.cent_wt = [5e1, 5e2]
air_bound.step_ht = 0.07
air_bound.reg_wt = [7e-3, 7e-5]

# Dyn
air_bound.W_X = np.array([1e-5, 1e-5, 5e4, 1e1, 1e1, 1e3, 5e3, 1e4, 5e3])
air_bound.W_X_ter = 10 * np.array([1e-5, 1e-5, 5e4, 1e1, 1e1, 1e3, 1e4, 1e4, 1e4])
air_bound.W_F = np.array(4 * [1e1, 1e1, 3e1])
