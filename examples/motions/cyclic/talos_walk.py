...
walk.stance_percent = 4 * [0.6,] + 4 * [
    0.6,
]
walk.gait_dt = 0.1
walk.phase_offset = 4 * [0.3,] + 4 * [
    0.8,
]
...
# Dyn
walk.W_X = np.array([1e4, 1e4, 1e5, 1e3, 1e2, 2e2, 1e4, 5e4, 1e4])
walk.W_X_ter = 10.0 * np.array([1e5, 1e5, 1e5, 1e1, 1e1, 2e2, 1e5, 1e5, 1e5])
...
# Gains
walk.kp = np.array(
    [1e3, 1e3, 5e3, 2e3, 5e3, 1e3]
    + [1e3, 1e3, 5e3, 2e3, 5e3, 1e3]  # left leg
    + 2  # right leg
    * [
        1e5,
    ]
