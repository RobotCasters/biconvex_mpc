...
trot.cent_wt = [3 * [5e2], 6 * [5e2]]  # CoM, Momentum
trot.step_ht = 0.15
trot.nom_ht = 0.27
trot.reg_wt = [5e-1, 1e-5]

# Dyn
trot.W_X = np.array([3e-3, 3e-3, 1e5, 5e4, 5e4, 2e2, 1e4, 1e5, 1e4])
trot.W_X_ter = 10 * np.array([1e5, 1e5, 5e5, 5e4, 5e4, 2e2, 1e5, 1e5, 1e5])
...
# Dyn
trot_turn.W_X = np.array([1e-5, 1e-5, 1e5, 1e1, 1e1, 2e2, 1e4, 1e4, 1e4])
