...
jump.stance_percent = 4 * [0.7,] + 4 * [
    0.7,
]
jump.gait_dt = 0.05
jump.phase_offset = 4 * [0.0,] + 4 * [
    0.0,
]
...
# Dyn
jump.W_X = np.array([1e4, 1e4, 1e2, 1e3, 1e2, 2e2, 1e4, 5e4, 1e4])
jump.W_X_ter = 10.0 * np.array([1e5, 1e5, 1e5, 1e1, 1e1, 2e2, 1e5, 1e5, 1e5])
...
# Gains
jump.kp = np.array(
    [1e5, 1e5, 1e5, 1e5, 1.5e3, 1e3]
    + [1e5, 1e5, 1e5, 1e5, 1.5e3, 1e3]  # left leg
    + 2  # right leg
    * [
        1e5,
    ]
